...
public class Effect : IdentifiedObject
{
    ...
    #region Event
    public delegate void StartedHandler(Effect effect);                                                             // Start
    public delegate void AppliedHandler(Effect effect, int currentApplyCount, int prevApplyCount);                  // Apply
    public delegate void ReleasedHandler(Effect effect);                                                            // Release
    public delegate void StackChangedHandler(Effect effect, int currentApplyCount, int prevApplyCount);             // StackChange
    #endregion
    ...
    // Effect가 새로 들어왔을 때 무엇을 제거하는지에 대한 타입
    [SerializeField]
