...
public class IdentifiedObjectEditor : Editor
{
    ...
    // Serailize된 변수들의 값을 조작하기 위한 class
    ...
    protected virtual void OnEnable()
    {
        ...
        // target 변수를 통해서 현재 내가 Editor에서 보고 있는 실제 IdentifiedObject 객체를 가져올 수 있음
        // var identifiedObject = target as IdentifiedObject
        // serializedObject도 targetObject 변수를 통해서 실제 IdentifiedObject 객체를 가져올 수 있음
